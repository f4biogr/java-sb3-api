...
public class ProductController {
    ...
    public ResponseEntity<EntityModel<ProductModel>> getOneProduct(
        ...
        Optional<ProductModel> product = findProduct(id);
        if (product.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null);
        }

        EntityModel<ProductModel> entityModel = EntityModel.of(product.get());
    ...
    private Optional<ProductModel> findProduct(UUID id) {
